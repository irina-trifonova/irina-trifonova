...
Заполни таблицу своими данными. Можно добавить сколько угодно строк.

| Название проекта | Описание проекта | Технологический стек |
|------------------|------------------|------------------------|
| Проект 1 | Короткое описание: что анализировала, какие выводы, решение задачи | Python, Pandas, SQL, DataLens, … |
| Проект 2 | ... | ... |
| Проект 3 | ... | ... |
...
Заполни нужные данные:

- **Email:** *irina2002184@gmail.com*  
- **Telegram:** *@irinatrina*  

---

⭐️ *Готова к сотрудничеству*  
